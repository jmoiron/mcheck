export class TypeGraph {
    types = new Map();
    registryMappings = new Map();
    dispatchMappings = new Map();
     ...
     */
    extractTypeDefinition(lines, startIndex) {
        let depth = 0;
        let inParens = false;
        let unionTypes = [];
        let hasStruct = false;
     ...
     */
    extractUnionTypes(lines, startIndex) {
        const unionTypes = [];
        let depth = 0;
        let inParens = false;
        for (let i = startIndex; i < lines.length; i++) {
     ...
     */
    extractStructFields(lines, startIndex) {
        const fields = {};
        let depth = 0;
        let inStruct = false;
        for (let i = startIndex; i < lines.length; i++) {
     ...
     */
    extractEnumValues(lines, startIndex) {
        const enumValues = [];
        let depth = 0;
        let inEnum = false;
        for (let i = startIndex; i < lines.length; i++) {
     ...
     */
    getExpectedTypeName(registryType) {
...
//# sourceMappingURL=type-graph.js.map