...
export class JsonValidator {
    ...
    typeGraph;
    verbose;
    constructor(parsedSchemas, verbose = false) {
     ...
     */
    async discoverJsonFiles(datpackPath) {
     ...
     */
    async validateJsonFile(filePath, datpackRoot = './worldgen') {
     ...
     */
    performTypeGraphValidation(jsonContent, fileInfo, expectedType) {
        const warnings = [];
     ...
     */
    performBasicValidation(jsonContent, fileInfo, expectedType) {
        const errors = [];
        const warnings = [];
     ...
     */
    validateNoiseSettings(noiseSettings) {
        const errors = [];
        const warnings = [];
